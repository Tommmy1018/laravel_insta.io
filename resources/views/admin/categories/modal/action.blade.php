        ...
        <form action="{{ route('admin.categories.update', $category->id) }}" method="post">
            ...
            <div class="modal-content border-warning">
                ...
                <div class="modal-footer border-0">
                    <button class="btn btn-outline-warning btn-sm" data-bs-dismiss="modal">
                        Cancel
                    </button>
        ...
        <form action="{{ route('admin.categories.destroy', $category->id) }}" method="post">
            ...
            <div class="modal-content border-danger">
                <div class="modal-header border-danger">
                    <h3 class="h5 modal-title">
                        <i class="fa-regular fa-trash-can text-danger"></i> Delete Category
                    </h3>
                </div>

                <div class="modal-body">
                    <p>Are you sure you want to delete <span class="fw-bold">{{ $category->name }}</span>?</p>
                    <p class="fw-light">This action will affect all the posts under this category. Post without category will fall under Uncategorized.</p>
                </div>
